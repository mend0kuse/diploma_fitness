...
let OrderService = class OrderService {
    ...
    createOrder(order) {
        return this.prismaService.workoutOrder.create({
            data: {
                ...order,
                status: order_1.ORDER_STATUS.PENDING,
            },
        });
    }
    getUserOrderByWorkoutId(userId, workoutId) {
